 ...
 * Tags: [unnamed string literals, array, pointer, const, const-qualified]
 */
#include <stdio.h>
#include <stdlib.h>
...
int main(int argc, [[maybe_unused]] char* argv[argc + 1]) {
    ...
    // To simulate the char* with an array, we can create a const-qualified object, to the constant "Kevin Telling"
    char const arrConstName[] = "Kevin " "Telling";
    arrConstName[0] = 'L'; // Will not crash, because the program wont compile. Try best to use this, so no runtime crashes happen.
